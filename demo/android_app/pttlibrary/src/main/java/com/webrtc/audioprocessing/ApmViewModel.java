...
public class ApmViewModel {
    ...
    private String aceBufferDelay = "120"; //原来 150, 单位 ms

    private int agcTargetLevelInt = 0;       //todo 原来是6, [0,31] 0 表示最大声音，
    private int agcCompressionGainInt = 12;  //todo 原来是9 ， compressionGaindB 是调节小音量的增益范围
    ...
    private boolean aecMobileMode4 = true; // loudspeakerphone
