...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> {
    ...
    public interface OnButtonClickListener {
         ...
         * @param user
         */
        void onButtonSingleTalkClick(PTTUser  user); // position 表示点击的 item 位置

        /**
         * 音视频通话, 基于webrtc
         * @param user
         */
        void onButtonRtcTalkClick(PTTUser user);
    ...
    public void onBindViewHolder(@NonNull ContactAdapter.ViewHolder holder, int position) {
        ...
        if(userEntry!=null){
            ...
            holder.phoneTV.setText(userEntry.getPhone());
        ...
        if (userEntry.getUserId().equals(MyPOCApplication.getInstance().getUserId())){
            ...
            holder.rtcTalkBTN.setVisibility(View.INVISIBLE);

        } else
        {
            holder.singleTalkBTN.setVisibility(View.VISIBLE);
            holder.rtcTalkBTN.setVisibility(View.VISIBLE);
        }

        holder.singleTalkBTN.setOnClickListener(v-> {
            if (listener != null) {
                listener.onButtonSingleTalkClick(userEntry); // 回调点击事件
            }
        });
        //
        holder.rtcTalkBTN.setOnClickListener(v->{
            if (listener != null) {
                listener.onButtonRtcTalkClick(userEntry); // 回调点击事件
            }
        });
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ImageView avatarIV;
        TextView useridTV;
        TextView phoneTV;  //显示登录帐号的，它可能和userId不一样了
        TextView  usernameTV;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            rtcTalkBTN= itemView.findViewById(R.id.btn_rtc_talk);
        }
    }
