...
public interface PTTApiService {
     ...
     */
    @POST("app/loginimei")
    Observable<LoginResponse>  loginimei(@Query("imei") String imei);
    ...
    //上报定位
    @GET("app/update-user-location")
    Observable<Object> updateUserLocation(@Query("group_id") Integer groupId,
                                          @Query("latitude")  Double latitude,
                                          @Query("longitude")  Double longitude,
                                          @Query("batterylevel")  Integer batterylevel,
                                          @Query("savelocday")  Integer savelocday);
