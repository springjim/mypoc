...
public class PTTGroupMember {
    ...
    private String  phone;  //有些登录帐号可能和userId不一样，这里用来显示
    private String  userName;
    private int logon;  //1：在线 0: 离线
    private Integer aclass;  //麦权
    private String  listen;  //n: 不在组 y: 在组

    public PTTGroupMember(Integer userId, String phone,  String userName, int logon, Integer aclass, String listen) {
        this.userId = userId;
        this.phone = phone;
