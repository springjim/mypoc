...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  public static class Builder {
    ...
    public JavaAudioDeviceModule createAudioDeviceModule() {
      ...
      //加入AudioAttributes.USAGE_MEDIA 才能使扬声器播放
      final WebRtcAudioTrack audioOutput =
          new WebRtcAudioTrack(context, audioManager, new AudioAttributes.Builder()
                  .setUsage(AudioAttributes.USAGE_MEDIA)  // 关键！使用媒体流特性
                  .build(), audioTrackErrorCallback,
